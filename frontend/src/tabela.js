...
function Tabela() {
    ...
    const comporConteudoEmail = (dados) => {
        return dados.map(item => {
            ...
            let assinatura = '';
            if (item.cnpj) {
                assinatura = `<p>Sua assinatura do tipo ${item.produto} em nome de ${item.razaoSocial} vencerá dia ${item.dataVencimento}, entre em contato conosco para realizarmos a renovação. Basta responder esse e-mail ou nos ligar nos números...</p>`;
            } else {
